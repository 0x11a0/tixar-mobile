...
export default LoginPage = ({ navigation }) => {
  ...
  const invAnimate3 = () => {
    ...
    return (
        ...
        {success2 && <Animated.View style={{
            transform: [{ translateX: -winWidth / 2 }, { translateX: regX },],
                opacity: regOpacity,
        ...
        {/* Translucent card */}
            ...
            <View style={[styles.buttonRow, {flex: 1, width: '95%'}]}>
        ...
        {!success1 && !success2 && <Animated.View style={{
