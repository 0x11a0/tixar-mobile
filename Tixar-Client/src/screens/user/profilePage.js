    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.translucentBox}>
                ...
                <Text style={[styles.subtitle, { color: colors.textPrimary }]}>{email}</Text>
                <Text style={[styles.title, { color: colors.textPrimary }]}>Phone Number</Text>
                <Text style={[styles.subtitle, { color: colors.textPrimary }]}>{phoneNumber}</Text>
                <View style={styles.buttonContainerStyle}>
                    <Button buttonText={"View Tickets"}
            ...
            <Text style={[styles.footerText, { color: colors.textPrimary }]}>TIXAR</Text>
        </SafeAreaView>
    );
};
